...
- **Dimensions**: Strictly **A0 Portrait** orientation (841 mm wide x 1189 mm high). Landscape posters are not supported due to display board size restrictions.
- **Header Details**: The top of the poster must clearly display the **Paper ID Code** (e.g., `MOP015`), the Paper Title, Author Names, and Affiliations.
- **Font & Sizing**:
  - *Title*: at least 48 pt.
  - *Headings*: at least 32 pt.
  - *Body Text*: at least 20 pt (readable from 1-2 meters distance).
- **Mounting**: Pin boards and double-sided tapes will be supplied by the local secretariat at each board station.
