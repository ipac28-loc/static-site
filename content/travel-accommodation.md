...
{{< tab-container >}}
    {{< tab title="Official Partner Hotels" >}}
These are high-quality, full-service hotels located within 5-15 minutes walking distance from the **Tokyo International Forum (TIF)**. We have negotiated exclusive discounted rates for IPAC'28 participants.
...
- **Cancellation Terms**: Exclusive discount bookings are cancellable free-of-charge up to 14 days before the check-in date. Refund structures for late cancellations are `To be added`.
- **Caution**: Please avoid third-party agency emails offering hotel booking services on behalf of IPAC. They are unaffiliated phishing operations. Always book directly through our official domain.
    {{< /tab >}}
{{< /tab-container >}}
